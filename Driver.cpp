...
reduction(+:totalRuns, cntr1, cntr2, cntr3, cntr4, cntr5, cntr6, cntr7, cntr8, cntr9, cntr10)
	...
	printf("\nProbability of getting Royal Flush: %f", 100 * double(cntr1) / double(totalRuns));
	printf("%%\nProbability of getting Straight Flush: %f", 100 * double(cntr2) / double(totalRuns));
	printf("%%\nProbability of getting Four Of A Kind: %f", 100 * double(cntr3) / double(totalRuns));
	printf("%%\nProbability of getting Full House: %f", 100 * double(cntr4) / double(totalRuns));
	printf("%%\nProbability of getting Flush: %f", 100 * double(cntr5) / double(totalRuns));
	printf("%%\nProbability of getting Straight: %f", 100 * double(cntr6) / double(totalRuns));
	printf("%%\nProbability of getting Three of a Kind: %f", 100 * double(cntr7) / double(totalRuns));
	printf("%%\nProbability of getting Two Pairs: %f", 100 * double(cntr8) / double(totalRuns));
	printf("%%\nProbability of getting One Pair: %f", 100 * double(cntr9) / double(totalRuns));
	printf("%%\nProbability of getting the High Card: %f", 100 * double(cntr10) / double(totalRuns));
	printf("%%\n");
